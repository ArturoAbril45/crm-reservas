<x-app-layout>
    ...
    <form method="GET" action="{{ route('reporte-ventas') }}" class="no-print bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6 flex flex-wrap items-end gap-4">
        <div>
            ...
            <input id="desde" name="desde" type="date" value="{{ $desde }}" class="mt-1.5 block rounded-lg border border-gray-300 px-3.5 py-2 text-sm text-gray-900 focus:border-[#9c0720] focus:outline-none focus:ring-1 focus:ring-[#9c0720]">
        </div>
        <div>
            <x-input-label for="hasta" value="Hasta" />
            <input id="hasta" name="hasta" type="date" value="{{ $hasta }}" class="mt-1.5 block rounded-lg border border-gray-300 px-3.5 py-2 text-sm text-gray-900 focus:border-[#9c0720] focus:outline-none focus:ring-1 focus:ring-[#9c0720]">
        </div>
        <div>
            <x-input-label for="sucursal_id" value="Sucursal" />
            <select id="sucursal_id" name="sucursal_id" class="mt-1.5 block rounded-lg border border-gray-300 px-3.5 py-2 text-sm text-gray-900 focus:border-[#9c0720] focus:outline-none focus:ring-1 focus:ring-[#9c0720]">
        ...
        <button type="submit" class="rounded-lg bg-[#9c0720] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#7c0519]">Filtrar</button>
